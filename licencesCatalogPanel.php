...
<body>
<button onclick="window.location.href = 'addLicence.php';">Dodaj licencje</button>
...
if ($select_query->num_rows > 0) {
    while ($data = $select_query->fetch_assoc()) {
        ...
        echo "<a href='deleteLicence.php?id=" . $data['id'] . "'>Usuń</a>";
      echo  "<br>";
        echo "<a href='editLicence.php?id=" . $data['id'] . "'>Edytuj</a>";
    }
}
