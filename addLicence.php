...
<div id="panel">
    ...
    <form method="post">
        ...
        <p>
            ...
            if(isset($_SESSION['fr_data_wsparcia']))
            {
                echo $_SESSION['fr_data_wsparcia'];
                unset($_SESSION['fr_data_wsparcia']);
            }
            ?>">
        </p>
        ...
        <p id="waznosc_licencji">
            ...
            if(isset($_SESSION['fr_data_waznosci']))
            {
                echo $_SESSION['fr_data_waznosci'];
                unset($_SESSION['fr_data_waznosci']);
            }
            ?>">
        </>
